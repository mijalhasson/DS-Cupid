...
async def ref_room_match(request_body: RoomData):
    try:
        ...
        df_matched, df_unmatched = reference_room_match(
            id_reference, df_reference, df_input
        )
        ...
        for supplier_room_id, group in grouped:
            mapped_rooms = group[
                ["supplier_room_id", "supplier_room_name", "match_score"]
        ...
        return JSONResponse(
            ...
            content={"error": "Server Error", "message": e},
        )
